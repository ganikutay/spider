...
static esp_err_t go_handler(httpd_req_t *req){              //ILERI
    digitalWrite(gpRf, HIGH);                                    //13
...
static esp_err_t back_handler(httpd_req_t *req){            //GERI yani dur
...
static esp_err_t left_handler(httpd_req_t *req){                //SOL
    digitalWrite(gpRf, LOW);                                   
    digitalWrite(gpLb, LOW);
    digitalWrite(gpLf, HIGH);                                 //14
    digitalWrite(gpRb, LOW);   
    Serial.println("Left");                 
    httpd_resp_set_type(req, "text/html");
    return httpd_resp_send(req, "OK", 2);
}
static esp_err_t right_handler(httpd_req_t *req){                 //SAG
    digitalWrite(gpRf, LOW);                                   
    digitalWrite(gpLb, LOW);
    digitalWrite(gpLf, LOW);
    digitalWrite(gpRb, HIGH);                                     //15
